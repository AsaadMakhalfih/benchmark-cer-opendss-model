...
for day in days:
    ...
    delta_p_q_settings = (0.175, 0.080, 0.120, 0.05, 0.172, 0.07, 0.12, 0.05)
    ...
    case_name = f'load_pv_battery_self_consumption_inv_con_hourly_{day}'
    Results.export_summary_results(path=os.path.dirname(__file__) + '/results', file_name=case_name)
    Results.export_energy_flow_results(path=os.path.dirname(__file__) + '/results', file_name=f'load_pv_battery_self_consumption_inv_con_energy_flow_hourly_{day}')
    case_name = f'load_pv_battery_self_consumption_inv_con_hourly'
