...
for day in days:
    ...
    case_name = f'load_pv_export_limit_hourly_{day}'
    Results.export_summary_results(path=os.path.dirname(__file__) + '/results', file_name=case_name)
    Results.export_energy_flow_results(path=os.path.dirname(__file__) + '/results', file_name=f'load_pv_export_limit_energy_flow_hourly_{day}')
    Results.export_reactive_power_results(path=os.path.dirname(__file__) + '/results', file_name=f'load_pv_export_limit_reactive_powers_hourly_{day}')
    Results.export_metrics(path=os.path.dirname(__file__) + '/results', file_name=f'load_pv_export_limit_metrics_hourly_{day}')
    Results.export_voltages(path=os.path.dirname(__file__) + '/results', file_name=f'load_pv_export_limit_voltages_hourly_{day}')
    Results.export_line_currents(path=os.path.dirname(__file__) + '/results', file_name=f'load_pv_export_limit_line_currents_hourly_{day}')
    Results.export_voltage_unbalance(path=os.path.dirname(__file__) + '/results', file_name=f'load_pv_export_limit_voltage_unbalance_hourly_{day}')
    Results.export_ac_curtailment(path=os.path.dirname(__file__) + '/results', file_name=f'load_pv_export_limit_ac_curtailment_hourly_{day}')
    Results.export_dc_curtailment(path=os.path.dirname(__file__) + '/results', file_name=f'load_pv_export_limit_dc_curtailment_hourly_{day}')
    Plots.plot_and_save_all(os.path.dirname(__file__) + f'/plots/load_pv_export_limit/{day}/', extra_disc=f'_{case_name}')