...
for day in days:
    ...
    case_name = f'load_pv_battery_time_of_use_inv_con_hourly_{day}'
    Results.export_summary_results(path=os.path.dirname(__file__) + '/results', file_name=case_name)
    Results.export_energy_flow_results(path=os.path.dirname(__file__) + '/results', file_name=f'load_pv_battery_time_of_use_inv_con_energy_flow_hourly_{day}')
    Results.export_metrics(path=os.path.dirname(__file__) + '/results', file_name=f'load_pv_battery_time_of_use_inv_con_metrics_hourly_{day}')
    Results.export_voltages(path=os.path.dirname(__file__) + '/results', file_name=f'load_pv_battery_time_of_use_inv_con_voltages_hourly_{day}')
    Results.export_line_currents(path=os.path.dirname(__file__) + '/results', file_name=f'load_pv_battery_time_of_use_inv_con_line_currents_hourly_{day}')
    Results.export_voltage_unbalance(path=os.path.dirname(__file__) + '/results', file_name=f'load_pv_battery_time_of_use_inv_con_voltage_unbalance_hourly_{day}')
    Results.export_ac_curtailment(path=os.path.dirname(__file__) + '/results', file_name=f'load_pv_battery_time_of_use_inv_con_ac_curtailment_hourly_{day}')
    Results.export_dc_curtailment(path=os.path.dirname(__file__) + '/results', file_name=f'load_pv_battery_time_of_use_inv_con_dc_curtailment_hourly_{day}')
