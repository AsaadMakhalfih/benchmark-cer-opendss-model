...
for day in days:
    ...
    delta_p_q_settings = (0.15, 0.05, 0.1, 0.05, 0.16, 0.05, 0.1, 0.05)
    ...
    case_name = f'load_pv_battery_time_of_use_managed_export_limit_hourly_{day}'
    Results.export_summary_results(path=os.path.dirname(__file__) + '/results', file_name=case_name)
    Results.export_energy_flow_results(path=os.path.dirname(__file__) + '/results', file_name=f'load_pv_battery_time_of_use_managed_export_limit_energy_flow_hourly_{day}')
    case_name = f'load_pv_battery_time_of_use_managed_export_limit_hourly'
