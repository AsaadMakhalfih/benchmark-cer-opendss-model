...
for day in days:
    ...
    if day == 'Summer_Weekday':
        delta_p_q_settings = (0.170, 0.070, 0.12, 0.05, 0.167, 0.065, 0.125, 0.05)
    else:
        delta_p_q_settings = (0.167, 0.065, 0.12, 0.05, 0.167, 0.065, 0.125, 0.05)
    ...
    case_name = f'load_pv_battery_self_consumption_v2g_inv_con_hourly_{day}'
    Results.export_summary_results(path=os.path.dirname(__file__) + '/results', file_name=case_name)
    Results.export_energy_flow_results(path=os.path.dirname(__file__) + '/results', file_name=f'load_pv_battery_self_consumption_v2g_inv_con_energy_flow_hourly_{day}')
    case_name = f'load_pv_battery_self_consumption_v2g_inv_con_hourly'
